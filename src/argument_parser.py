...
def default_parser():
    ...
    parser.add_argument("--normalize_sequence",
                        default=False,
                        type=boolean_string,
    ...
    parser.add_argument("--use_pooled_output",
                        default=False,
                        type=boolean_string,
                        help="whether use pooled_output or not")
    return parser
...
def get_predefine_argv(mode='glue', task_name='SST-2', train_type='kd'):
    """
    ...
    if mode == 'race':
        ...
        if train_type == 'finetune_student':
            ...
            argv += [
                ...
                '--alpha', '0.7',
                '--T', '20',
                '--teacher_prediction', f'./data/outputs/KD/{task_name}/0.9362987369577156_{task_name}_add_seq_kd_teacher_12layer_result_summary.pkl',
            ]

        elif train_type == 'kd.prog':
            argv += [
                '--learning_rate','1e-5',
                ...
                '--T','10',
                '--beta','500',
                '--teacher_prediction',f'./data/outputs/KD/{task_name}/0.9362987369577156_{task_name}_add_seq_kd_teacher_12layer_rasult_summary.pkl',
